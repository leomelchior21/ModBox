...
const ALL_CHIPS: ChipToken[] = [
  ...
  { id: 'decl:shipType', label: 'shipType', insert: 'string shipType = "scout";', group: 'mod' },
  { id: 'decl:backgroundColor', label: 'backgroundColor', insert: 'string backgroundColor = "purple";', group: 'mod' },
  { id: 'decl:rockShape', label: 'rockShape', insert: 'string rockShape = "crystal";', group: 'mod' },
